...
# Данный тест закомментирован, так как его функционал взял на себя другой тест который находится в test_cannot_vote_on_draft_board()
# Отчет по нему остался в старом репозитории
